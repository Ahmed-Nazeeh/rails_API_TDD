...
RSpec.describe ArticlesController do 
    describe '#index' do 
       it 'returns a success response' do 
            get '/articles'
            # expect(response.status).to eq(:ok)  # This line equal to the next one
       ...
       it 'returns a proper JSON' do 
            ...
            get '/articles'
                ...
                #         }
                #     ]
                # )                                    # last lines can be DRY to the next few lines
       ...
       it 'paginates results' do 
        article1, article2, article3 = create_list(:article, 3) # This line accepted by factory bot gem to create more than one objects
